                    ...
                    <div class="col-md-10 mx-auto ">
                        <div class="card rounded-3 shadow-lg">
                            ...
                            <div class="card-body bg-light">
                                ...
                                <!--Form-->
                                <f:form action="addGroup" method="POST" modelAttribute="groupModel">
                                    <div class="row mt-1">
                                        <div class="col mb-3">
                                    ...
                                    <div style="text-align: right" class="mt-1">
                                        <button type="submit" class="btn me-2" style="background-color: #fd788a; color: white">Register</button>
